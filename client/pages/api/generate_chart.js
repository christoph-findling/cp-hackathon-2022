...
export default function handler(req, res) {
  ...
  function generateChart(data) {
    ...
    svg
      ...
      .attr('transform', function(d, index) { return 'translate(' + (width + 25) + ',' + ((height / 2) - 20 + (index * (fontSize + 5)))  + ')' })
      ...
      .attr('cx', 0)
      .attr('cy', -8)
      .attr('transform', function(d, index) { return 'translate(' + (width + 10) + ',' + ((height / 2) - 20 + (index * (fontSize + 5)))  + ')' })
