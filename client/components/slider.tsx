...
const compProps = (interactive: boolean) => {
    return {
        thumb: { className: 'ring-cyan-500 dark:ring-cyan-400 ring-2 w-9 h-6 -mt-2 text-sm -ml-2 flex items-center justify-center bg-white rounded-full shadow absolute' },
...
const AssetSelector = ({ input }: { input?: SliderInput }) => {
    ...
    const uncontrolledSlider = riskyCurrent > 0 || midCurrent > 0 || stableCurrent > 0;
    ...
    // Update button status on maxVal update => updating maxVal auto updates the currentVal
    ...
    return (
        <>
            ...
            <p className='mt-2 mb-1'>Stable</p>
